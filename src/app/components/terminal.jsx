...
//       // Update trades and closedTrades to reflect the closed trade
...
//         demoBalance: dynamicBalance, // Send the current dynamicBalance
//         username: parsedUserDetails.username,
//         userId: parsedUserDetails.id
//       });
//       }
...
//   useEffect(() => {
//     updateBalance();
//   }, [isTradeClosed]); // Run when isTradeClosed changes
...
//           <div className="text-xl">$</div> {dynamicBalance !==null ? (dynamicBalance.toFixed(3)):' '}</div>
...
//         <div className="lg:w-[25vw] border-r-4 border-slate-600 border-box w-[100vw] h-[12vh] lg:h-[92vh] bg-zinc-950 ">
...
//               <li className="bg-green-700 h-[50px] text-xl font-semibold text-white mb-3 rounded-lg flex items-center justify-around">
//                 <span>Your Balance</span>
//                 <span>$ {dynamicBalance !==null ? (dynamicBalance.toFixed(3)):' '}</span>
//               </li>
//               <li className="bg-red-700 h-[50px] text-xl font-semibold text-white rounded-lg flex items-center justify-around">
//                 {
...
//         <div className="lg:w-[60vw] w-[100vw] h-[80vh] lg:h-[92vh] bg-slate-80 flex flex-col">
...
//   {activeButton !==null && (
//     <div className="overflow-y-auto h-full max-h-[190px] custom-scrollbar">
//       {/* Header */}
//       <div className="flex bg-gray-900 text-slate-400 text-[12px] sticky top-0 z-10 gap-x-2">
//         <div className="w-1/12 min-w-[100px] p-2">Symbol</div>
//         <div className="w-1/12 min-w-[100px] p-2">Sell/Buy</div>
//         <div className="w-1/12 min-w-[100px] p-2">Volume</div>
//         <div className="w-1/12 min-w-[100px] p-2">Margin</div>
//         <div className="w-1/12 min-w-[100px] p-2">OpeningPrice</div>
//         {
//           activeButton ===1 ?(<div className="w-1/12 min-w-[100px] mr-4 p-2">CurrentPrice</div>) : ""
//         }
//         <div className="w-1/12 min-w-[100px]  -mr-7 p-2">Profit</div>
//         {
//           activeButton ===1 ?(<div className="w-1/12 min-w-[100px] mr-4 p-2">CloseTrade</div>) : ""
//         }
//         <div className="w-1/12 min-w-[100px] mr-5  p-2">OpeningTime</div>
//         {
//           activeButton ===3 ?(<div className="w-1/12 min-w-[100px] mr-4 p-2">ClosingTime</div>) : ""
//         }
//         <div className="w-1/12 min-w-[100px]  p-2">TakeProfit</div>
//         <div className="w-1/12 min-w-[100px]   p-2">StopLoss</div>
//       </div>
