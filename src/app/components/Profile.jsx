          ...
          <div className="layout-content-container flex flex-col w-full md:w-80">
            <div className="flex flex-col items-center p-4">
              <div className="flex flex-col items-center gap-4">
                <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full bg-white h-28 lg:h-32 w-28 lg:w-32 text-green-900  flex  items-center justify-center text-6xl lg:text-7xl">
                  P
                </div>
            ...
            <div className="flex flex-col items-center lg:items-stretch gap-2 px-4 py-3">
              <button className="flex items-center justify-center rounded-full h-8 lg:h-12 px-5  text-[#1C160C] text-base font-bold w-[250px] lg:w-full bg-gradient-to-r bg-slate-200 hover:bg-slate-600 hover:text-white">
              ...
              <button
                ...
                className="flex items-center justify-center rounded-full h-8 lg:h-12 px-5 bg-blue-700 text-[#FFFFFF] hover:bg-blue-600 text-base font-bold w-[250px] lg:w-full"
              >
                <span className="truncate">Start Game</span>
              </button>
              <button
                onClick={handleSignOut}
                className="flex items-center justify-center rounded-full h-8 lg:h-12 px-5 bg-[#FFFFFF] text-[#D14238] text-base font-bold border border-solid border-[#D14238] w-[250px] lg:w-full"
              >
                <span className="truncate">Log Out</span>
              </button>
            </div>
          </div>
          <div className="layout-content-container flex flex-col items-center gap-4  w-full">
            <div className="layout-section-container flex flex-col">
              <div className="flex flex-col lg:-mt-10 justify-between gap-2">
                <div className="flex  justify-center items-center p-2 ">
                  <span className="lg:text-6xl lg:mt-8 text-3xl md:text-5xl md:h-auto leading-none w-full font-medium text-gradient text-center">
                    Your Performance
                  </span>
                </div>
                <div className=" text-white mt-4 md:mt-2 text-center grid grid-cols-2  border-2 border-gray-300 rounded-xl">
                  <div className=" bg-blue-600 rounded-l-lg  ">
                    <span className="text-l lg:text-2xl">60</span>
                    <div className="lg:text-2xl text-l text-white font-normal font-mono">
                      Trades
                    </div>
                  </div>
                  <div className=" bg-blue-700   rounded-r-lg">
                    <span className="lg:text-2xl text-l">4/5</span>
                    <div className="lg:text-2xl text-l text-white font-normal font-mono">
                      WinRate
                    </div>
                  </div>
                ...
                <div className="text-white mt-4 md:mt-2 text-center grid grid-cols-2 border-2 border-gray-300 rounded-xl">
                  <div className="  bg-blue-600 rounded-l-lg ">
                    <span className="lg:text-2xl text-l">5%</span>
                    <div className="lg:text-2xl text-l text-white font-normal font-mono">
                      ROC
                    </div>
                  </div>
                  <div className=" bg-blue-700  rounded-r-lg  ">
                    <span className="lg:text-2xl text-l">123</span>
                    <div className="lg:text-2xl text-l text-white  font-normal font-mono">
                      Rank
                    </div>
                  </div>
            ...
            <div className="layout-section-container flex flex-col w-full">
              <div className="flex flex-col justify-center gap-2 lg:w-full w-[90vw]">
                <div className="flex justify-between gap-2 w-full">
                  <span className="text-xl lg:text-2xl p-4 font-semibold text-[#f4a261]">
                    Trade History:
                  </span>
                </div>
                <div className="grid grid-cols-4 mr-1 lg:m-0 font-semibold text-center text-white  text-xs lg:text-xl md:text-xl">
                  <p>Rank</p>
                  <p>Name</p>
                  <p>Win/lose</p>
                ...
                <div className=" text-center text-md bg-gradient-to-r w-[90vw] lg:w-full rounded-xl bg-[#E4E0E1] p-4">
                  ...
                  <div className="grid grid-cols-4 text-xs lg:text-lg p-1">
                    <span className="-ml-5">123</span>
                    <span>Priyanshu Ranjan</span>
                    <span>Won</span>
                    <span>+100</span>
                ...
                <div className="text-center">
                  <button className=" text-start font-mono text-slate-300 hover:text-blue-500 p-1 rounded-lg text-xs lg:text-lg flex justify-center">
                    {" "}
